...
//The random nested branch chooses an index within it's list randomily and the ends.
...
//The random nested branch is NOT excluded until all it's indexes have been played.
...
with branch
{
    ...
    while !found
    {
        ...
        {
            //Check if data is B_RN type branch.
            if data.object_index = branch and data.type = B_RN
            {
                //Doesn't update played.
                found = true;
                break;
            }
            else
    ...
    //Checks if all indexes have been played.
    if scr_dialogue_check(id)
    {
        //Marks branch as played.
        played = true;
    }
